...
function Toggle({ id }) {
  ...
  function handleClick(e) {
    ...
    // Derive position of the button list
...
function List({ id, children }) {
  ...
  return createPortal(
    ...
    document.body
    //CreaePortal and document.body makes sure that the list is not under any
    //component, it is directly under the body(on inspection);
  );
}
